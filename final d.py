...
.value-blue{{
    ...
    color:transparent!important;padding:4px 11px;margin:0 auto;white-space:nowrap;width:100%;
...
.value-green{{
    ...
    -webkit-text-fill-color:transparent; color:transparent!important; text-shadow:0 3px 8px #fffbe8,0 5px 16px #00df6c,0 10px 30px #aef9e2;
...
.title-orange{{
    color:#fc7d1b!important; font-size:17px!important; font-weight:800!important; margin-top:7px!important; width:100%; text-align:center!important;
}}
.title-blue{{
...
.title-green{{
    color:{GREEN}!important; font-size:22px!important; font-weight:750!important; margin-top:4px!important;
}}
.chart-title-black{{
...
<div class="container">
    ...
    <!-- Row 1: Today's Sale | Rejection Amount | Date -->
    <div class="card">
    ...
    <!-- Row 2: Gauge | Rejection % | COPQ Text -->
    <div class="card">
    ...
    <!-- Row 3: Sale Trend | Rejection Trend | Rejection (Cumulative) -->
...
window.addEventListener("DOMContentLoaded",function() {{
    [ "snowdate","snowsale","snowoee","snowrej","snowach","snowrejcum",
      "snowspeed","snowsalechart","snowrejchart","snowrejamt","snowcopq"
