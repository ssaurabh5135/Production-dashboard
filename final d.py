...
# ---------- HTML + CSS UPDATED BLOCK (GAUGE NOW MATCHES 3D STYLE + 38PX FONT + NO TOUCH CORNERS) ---------- #
...
:root {{
    ...
    --gauge-blue: #00c3ff;
    --gauge-glow: rgba(0,195,255,0.55);
}}
        ...
        Plotly.newPlot(
            ...
            [{{
                ...
                gauge: {{
                    ...
                    steps: [
                        {{ range: [0,100], color: "rgba(0,195,255,0.12)" }}
                    ]
                }}
            }}],
            {{
