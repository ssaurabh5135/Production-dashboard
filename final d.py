...
.container {{
    ...
    grid-template-rows: 150px 170px 170px;
    gap: 18px 18px;
    row-gap: 30px;
    max-width: 1700px;
    max-height: 900px;
...
.chart-title-black {{
    color: #003!important; font-size:16px!important; font-weight:700!important; margin-bottom:3px!important;
...
<body>
<div class="container">
    <!-- Top Row (left to right): Today's Sale | Rejection Amount | Date -->
    <div class="card">
    ...
    <!-- Middle Row (left to right): Gauge | Rejection % | COPQ -->
    <div class="card">
    ...
    <!-- Bottom Row (left to right): Sale Trend | Rejection Trend | Rejection (Cumulative) -->
...
window.addEventListener("DOMContentLoaded",function() {{
    [ "snowsale","snowrejamt","snowdate","snowspeed","snowrej","snowcopq",
...
st.components.v1.html(html_template, height=810, scrolling=True)
