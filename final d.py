...
# ---------- HTML + CSS UPDATED BLOCK (NEON BLUE GRAPH + NO TOUCH TOP/LEFT/RIGHT + 38PX FONT) ---------- #
...
.container {{
    width: 100vw;
    height: 100vh;
    padding: 60px 70px 0 70px !important; /* FIXED: NO TOUCH TOP/LEFT/RIGHT */
    display: grid;
    grid-template-columns: 1fr 1fr 1fr;
    grid-template-rows: 130px 220px 140px 140px;
    gap: 26px;
...
<div class="card">
    <canvas class="snow-bg" id="snowsalechart"></canvas>
    <div class="chart-title-black">Sale Trend</div>
    <div id="sale_chart_container" class="chart-container">

        <!-- NEON BLUE TREND LINE -->
        <script>
        var neonSale = document.getElementById('neon_sale');
