...
def render_dashboard(selected_month):
    ...
    st.markdown(f"""
    <style>
    body, .stApp {{ background-size: cover !important; background-position: center center !important; margin:0 !important; padding:0 !important; overflow:hidden !important; }}
