...
.value-orange {{
    background-image: linear-gradient(92deg, #fffbe8 0%, #ffa940 43%, #fc7d1b 100%);
    text-shadow:
     0 1.5px 0 #ffd,
     0 3px 4px #fc7d1b,
     0 4px 12px #fcb147,
...
.value-blue {{
    background-image: linear-gradient(100deg, #b9e6ff 0%, #228be6 84%, #4ddbf7 100%);
    text-shadow:
     0 1px 4px #228be6,
     0 6px 14px #228be6,
     0 2.5px 28px #b9e6ff,
...
<div class="container">
    <div class="card top-card">
        <div class="center-content">
            <span class="value-orange" id="dt" data-value="0">{top_date}</span>
            <div class="title-black">Date</div>
        </div>
    </div>
    <div class="card top-card">
        <div class="center-content">
            <span class="value-blue" id="todaysale" data-value="{top_today_sale.replace(',','')}">0</span>
            <div class="title-black">Today's Sale</div>
        </div>
    </div>
    <div class="card top-card">
        <div class="center-content">
            <span class="value-orange" id="oee" data-value="{top_oee}">0%</span>
            <div class="title-black">OEE %</div>
        </div>
    </div>
    <div class="card">
        <div class="center-content">
            <span class="value-orange" id="rejpct" data-value="{left_rej_pct.replace('%','').strip()}">0%</span>
    ...
    <div class="card bottom-card">
        <div class="center-content">
            <span class="value-orange" id="rejcum" data-value="{bottom_rej_cum.replace(',','')}">0</span>
