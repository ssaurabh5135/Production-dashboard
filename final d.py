...
# ---------- Month list and selected month (logic only) ----------
...
.chart-container {{
    ...
    padding:25px 5px 5px 5px; box-sizing: border-box;
}}
.snow-bg {{
...
# Render the dashboard (cards) – selector stays outside so cards don’t move
st.components.v1.html(html_template, height=900, scrolling=True)

# ---------- Month selector BELOW dashboard ----------
