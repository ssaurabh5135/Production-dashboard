...
.value-green {{
    ...
    border-radius:10px;
    animation:popval 1.1s cubic-bezier(.14,.86,.29,1.08) both, shimmer 3.4s linear infinite;
    background-size:200% 100%;
    text-align:center;
    margin-bottom:4px;
}}
...
<div class="container">
    ...
    <div class="card">
      ...
      <div class="center-content">
        ...
        <div class="title-pink">Rejection %</div>
      </div>
    </div>
    <div class="card">
      <canvas class="snow-bg" id="snowdate"></canvas>
      <div class="center-content">
        <div class="value-glow-blue" id="datevalue">{top_date}</div>
        <div class="title-pink">Date</div>
      </div>
    </div>

    <!-- Row 2: Sale Trend | Achieved % | Today's Sale -->
    ...
    <div class="card">
      ...
      <div class="center-content">
        ...
        <div class="title-pink">Achieved %</div>
      </div>
    </div>
    <div class="card">
      <canvas class="snow-bg" id="snowsale"></canvas>
      <div class="center-content">
        <div class="value-glow-blue" id="salevalue">₹ {top_today_sale}</div>
        <div class="title-pink">Today's Sale</div>
      </div>
    </div>

    <!-- Row 3: Rejection Trend | Gauge | OEE % -->
    <div class="card bottom-card">
    ...
    <div class="card">
      ...
      <div class="center-content">
        <div class="value-glow-blue" id="oeevalue">{top_oee}</div>
        <div class="title-pink">OEE %</div>
      </div>
    </div>
</div>
