...
.value-orange{{
    ...
    -webkit-text-stroke:1.2px #b96000;filter:drop-shadow(0 4px 18px #fc7d1b);border-radius:10px;
    animation:popval 1.18s cubic-bezier(0.14,0.86,0.29,1.08) both,shimmer 3.2s linear infinite;
    background-size:200% 100%;text-align:center;margin-bottom:4px;
}}
.value-green{{
    font-size:54px!important;font-weight:900!important;font-family:'Poppins','Segoe UI',Arial,sans-serif;
...
.container{{width:100vw;height:100vh;padding:5vw;display:grid;grid-template-columns:1fr 1fr 1fr;
    grid-template-rows: 150px 150px 150px;gap:18px;row-gap:30px;max-width:1700px;max-height:900px;margin:auto;
}}
.center-content{{width:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0;margin:0;}}
.chart-title-black{{color: #003!important; font-size:16px!important; font-weight:700!important; margin-bottom:3px!important; width:100%; text-align:left!important; padding-left:7px;}}
.chart-container{{width:100%; height:110px; overflow:hidden; box-sizing:border-box; margin:0; padding:0; display:block;}}
.title-black{{
    color:#191921!important;font-size:17px!important;font-weight:800!important;margin-top:7px!important;
    width:100%;text-align:center!important;
}}
.title-blue{{
    color:#228be6!important;font-size:18px!important;font-weight:900!important;margin-top:7px!important;
    letter-spacing:0.06em;text-align:center!important;text-shadow:0 2px 5px #79cafc;
}}
.title-orange{{
    color:#fc7d1b!important;font-size:17px!important;font-weight:800!important;margin-top:7px!important;
    width:100%;text-align:center!important;
}}
</style>
</head>
...
<div class="container">
    ...
    <div class="card">
      ...
      <div class="center-content">
        ...
        <div class="title-blue">Today's Sale</div>
      </div>
    </div>
    <div class="card">
      <canvas class="snow-bg" id="snowrejamt"></canvas>
      <div class="center-content">
        <div class="value-orange" id="rejamt">{format_inr(rej_day)}</div>
        <div class="title-orange">Rejection Amount</div>
      </div>
    </div>
    <div class="card">
    ...
    <div class="card">
      ...
      <div class="center-content">
        ...
        <div class="title-orange">Rejection %</div>
      </div>
    </div>
    <div class="card">
      <canvas class="snow-bg" id="snowcopq"></canvas>
      <div class="center-content">
        <div class="value-blue" id="copqval">COPQ Updating...</div>
    ...
    <div class="card">
      ...
      <div class="center-content">
        ...
        <div class="title-orange">Rejection (Cumulative)</div>
      </div>
    </div>
</div>
<script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
<script>
function makeSnow(canvas) {{ /* unchanged */ }}
window.addEventListener("DOMContentLoaded",function() {{
    [ "snowsale","snowrejamt","snowdate","snowspeed","snowrej","snowcopq","snowsalechart","snowrejchart","snowrejcum"
    ].forEach(function(id){{ var el=document.getElementById(id); if(el) setTimeout(function(){{makeSnow(el)}},120); }});
}});
function animateValue(element, start, end, duration, suffix="", prefix="") {{ /* unchanged */ }}
window.addEventListener("DOMContentLoaded", function() {{
...
st.components.v1.html(html_template, height=830, scrolling=True)
