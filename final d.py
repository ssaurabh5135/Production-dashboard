...
fig_sale.add_trace(go.Bar(
    x=sale_df["date"], y=sale_df["sale amount"],
    marker_color=bar_gradients, marker_line_width=1, opacity=0.98
))
...
fig_rej.add_trace(go.Scatter(
    ...
    mode="lines+markers",
    marker=dict(size=9, color="rgba(252,125,27,1)", line=dict(width=1.5, color="#fff")),
    line=dict(width=7, color="rgba(252,125,27,0.97)", shape='spline'),
    hoverinfo="x+y",
    opacity=1
))
fig_rej.add_trace(go.Scatter(
...
.value-green {{
    ...
    filter:drop-shadow(0 4px 16px #00df6c); border-radius:10px; box-shadow:0 1.5px 14px #8cffca; animation:popval 1.1s cubic-bezier(.14,.86,.29,1.08) both, shimmer 3.4s linear infinite; background-size:200% 100%; text-align:center; margin-bottom:4px;
}}
@keyframes popval {{
...
<div class="container">
    ...
    <div class="card top-card">
        <div class="center-content">
            <div class="value-orange" id="dateval">{top_date}</div>
            <div class="title-black">Date</div>
        </div>
    </div>
    <div class="card top-card">
        <div class="center-content">
            <div class="value-blue" id="saleval">₹ {top_today_sale}</div>
            <div class="title-black">Today's Sale</div>
        </div>
    </div>
    <div class="card top-card">
        <div class="center-content">
            <div class="value-orange" id="oeeval">{top_oee}</div>
    ...
    <div class="card bottom-card">
        <div class="center-content">
            <div class="value-orange" id="cumval">₹ {bottom_rej_cum}</div>
