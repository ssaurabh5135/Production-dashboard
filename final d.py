...
.card {{
    ...
    box-shadow: 0 8px 32px rgba(10,28,46,0.11);
...
.center-content {{
    /* Remove ALL extra backgrounds/shadows from center (no inner box effects) */
    width:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0;margin:0;box-shadow:none!important;background:none!important;border:none!important;
}}
</style>
</head>
<body>
